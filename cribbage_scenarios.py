...
from cribsandladders.Player import RandomCribbageAgent, HumanAgent, GreedyCribbageAgent,Player
from cribsandladders.CribbageGame import CribbageGame
from cribsandladders.Deck import *
...
if __name__ == "__main__":
    ...
    run_discard_scenarios([(5,HEARTS),(5,DIAMONDS),(5,SPADES),(10,CLUBS),(9,SPADES),(10,DIAMONDS)], Player())
