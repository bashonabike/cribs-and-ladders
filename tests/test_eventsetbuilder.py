...
# 0/1 harness work -- pytest's testpaths is scoped to tests/. No other
# changes.
#
# NOTE: this exercises EventSetBuilder (Tier 3/4 per the TDD refactor
# assessment) and needs numpy + pandas (via cribsandladders.Board) to
# import. It's not runnable in a minimal environment the way
# test_deck.py / test_score_hand.py / test_config.py are. game_params
# is still read directly here (not injected) -- that's Phase 3/4 work.
